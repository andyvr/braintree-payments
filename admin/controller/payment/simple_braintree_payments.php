...
class ControllerPaymentSimpleBraintreePayments extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['simple_braintree_payments_method'])) {
			$this->data['simple_braintree_payments_method'] = $this->request->post['simple_braintree_payments_method'];
		} else {
			$this->data['simple_braintree_payments_method'] = $this->config->get('simple_braintree_payments_method');
		}
